...
(function ($) {
  ...
  // Browser Back/Forward Cache (bfcache) Safe Dismissal
  window.addEventListener("pageshow", function (event) {
    ...
    const laserOverlay = document.getElementById("transmission-laser-overlay");
    if (laserOverlay) {
      laserOverlay.classList.remove("is-active");
    }
  });
  ...
  // Auto-close offcanvas on menu link click and smooth scroll
  $(".tw-main-menu-mobile a, .tw-offcanvas-2-wrapper a").on("click", function (e) {
  ...
  $(document).ready(function () {
    ...
    // Robust Multi-Trigger Autoplay Engine for all Video Elements (Cards & Full Section Backgrounds)
    function initAllVideos() {
      const allVideos = document.querySelectorAll(".hero-card-video, .skill-card-video, .section-full-bg-video");
      ...
      // User interaction fallback (unlocks strict mobile/browser autoplay policies)
